...
public class RecipeIngredient extends Ingredient {
	...
	public boolean equals(Object test) {
		if (test instanceof RecipeIngredient) {
			...
			if (ingredient.getName().equals(this.getName())
					&& (ingredient.getMeasuringUnit().equals(this.getMeasuringUnit()))
					&& (ingredient.getCaloriesPerUnit() == this.getCaloriesPerUnit())
					&& (ingredient.getQuantity() == this.getQuantity())) {
				return true;
			}
